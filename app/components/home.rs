...
pub fn HomeScreen() -> Element {
    ...
    let featured = library::featured_songs();
    let discovery_options = search::discovery_options();
    ...
    rsx! {
        main { class: "utago-app",
            ...
            nav { class: "quick-actions", aria_label: "song entry",
                Link { class: "quick-action", to: Route::AddSong {},
                    Icon { kind: IconKind::Link }
                    span { "Add Spotify" }
                }
                Link { class: "quick-action quick-action--accent", to: Route::AddLocalSong {},
            ...
            section { class: "library-strip", aria_label: "library preview",
            ...
            section { class: "discovery-rail", aria_label: "discovery options",
                for option in discovery_options {
                    div { class: "discovery-token",
                        span { "{option.label}" }
                        small { "{option.detail}" }
                    }
                }
